...
function Category(){
    ...
    return (
        <div className={styles.category}>
          ...
          <div className={styles.option}><img src={require(`${path}ricecake.png`)} className={styles.img} alt="스콘"/>떡</div>
          <div className={styles.option}><img src={require(`${path}parfait.png`)} className={styles.img} alt="스콘"/>파르페</div>
          <div className={styles.option}><img src={require(`${path}tart.png`)} className={styles.img} alt="스콘"/>에그타르트</div>
