        ...
        <>
            <div className={styles.box}>
                ...
                <article className={styles.question}>
                    <p className={styles.text}> Q1. 친구와 디저트를 먹으러 가자고 했다. 근데 갑자기 약속이 취소되었다면?</p>
                ...
                <article className={styles.question}>
                    <p className={styles.text}> Q2. 회사에서 점심 먹고 항상 디저트를 먹었는데.. 오늘은 아무말도 없네? 나는 어떻게 할까?</p>
                ...
                <article className={styles.question}>
                    <p className={styles.text}> Q3. 디저트를 담다 실수로 넘어져버린 나 ..</p>
                ...
                <article className={styles.question}>
                    <p className={styles.text}> Q4. 디저트 원데이 클래스를 하게 되었다. 내가 만들고 싶은 디저트는?</p>
                ...
                <article className={styles.question}>
                    <p className={styles.text}> Q5. 내 최애 디저트에 대해 설명할 때 나는?</p>
                ...
                <article className={styles.question}>
                    <p className={styles.text}> Q6. 내일 디저트 맛집을 뿌시기로 했다. 나라면?</p>
                ...
                <article className={styles.question}>
                    <p className={styles.text}> Q7. 우울해서 디저트를 먹을거라며 전화를 한 친구, 친구에게 할 말은?</p>
                ...
                <article className={styles.question}>
                    <p className={styles.text}> Q8. 친구와 사이좋게 케이크를 나눠먹던 중 한조각이 남았을 때 나는</p>
                ...
                <article className={styles.question}>
                    <p className={styles.text}> Q9. 내 최애 디저트가 맛없다는 후기를 봤을 때 나는</p>
                ...
                <article className={styles.question}>
                    <p className={styles.text}> Q10. 갑자기 디저트가 먹고 싶어진 당신!</p>
                ...
                <article className={styles.question}>
                    <p className={styles.text}> Q11. 디저트 카페에서 일하게 되어 레시피를 다 외워야한다. 어떻게 외울 것인가?</p>
                ...
                <article className={styles.question}>
                    <p className={styles.text}> Q12. 오프닝을 노려야 하는 디저트 맛집. 그런데 눈떠보니 오프닝 5분 전이다. 나라면</p>
